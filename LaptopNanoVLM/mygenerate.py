...
def parse_args():
    ...
    parser.add_argument("--image", type=str, default="assets/PCB.png",
...
def main():
    ...
    source = "checkpoint" #args.checkpoint if args.checkpoint else args.hf_model
    model_source = "..\..\.cache\huggingface\hub\models--lusxvr--nanoVLM-222M\snapshots\9df794e259cb178223acfb1f3bc3b29521e551c5"
    #"C:\Users\trent\.cache\huggingface\hub\models--lusxvr--nanoVLM-222M\snapshots\9df794e259cb178223acfb1f3bc3b29521e551c5" #this folder?
